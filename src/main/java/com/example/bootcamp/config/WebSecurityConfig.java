...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/volunteer/{name}").hasAnyAuthority("ROLE_USER", "ROLE_ADMIN")
                .antMatchers("/api/volunteer").hasAnyAuthority("ROLE_USER", "ROLE_ADMIN")
                .antMatchers("/api/volunteer/**").hasAuthority("ROLE_ADMIN")
